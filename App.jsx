  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: "28px 24px 16px", zIndex: 1,
      ...
      <div style={{
        ...
        padding: "24px", zIndex: 1, overflowY: "auto",
        ...
        {messages.length === 0 && (
          <div style={{
            ...
            gap: "12px", opacity: 0.5, marginTop: "20vh",
          }}>
            <div style={{ fontSize: "48px" }}>✦</div>
            <div style={{ color: "#94a3b8", fontSize: "14px", textAlign: "center", lineHeight: 1.7 }}>
              Selamat datang di NOVA AI<br />Tanyakan apa saja.
            </div>
          </div>
        )}
          ...
          <div key={i} style={{
            ...
            {msg.role === "assistant" && (
              <div style={{
                ...
                background: "linear-gradient(135deg, #6366f1, #8b5cf6)",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: "13px", marginRight: "10px", flexShrink: 0, marginTop: "2px",
              }}>✦</div>
            )}
            <div style={{
              maxWidth: "78%",
              ...
              color: "#e2e8f0", fontSize: "14px", lineHeight: "1.75",
      ...
      <div style={{
        width: "100%", maxWidth: "720px",
        padding: "16px 24px 28px", zIndex: 1,
        ...
        <div style={{
          ...
          <textarea
            ...
            style={{
              ...
              resize: "none", lineHeight: "1.6", maxHeight: "140px",
              overflowY: "auto", paddingTop: "6px", paddingBottom: "6px",
            }}
            onInput={e => {
          ...
          <button
            ...
            style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              fontSize: "18px", color: "white", transition: "all 0.2s", flexShrink: 0,
              boxShadow: input.trim() && !loading ? "0 4px 15px rgba(99,102,241,0.4)" : "none",
            }}
          >↑</button>
        </div>
        <div style={{ textAlign: "center", marginTop: "10px", color: "rgba(255,255,255,0.2)", fontSize: "11px", letterSpacing: "0.1em" }}>
